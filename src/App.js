...
function App() {
  ...
  const increase=()=>{
    if(document.getElementById("inputID").value >= 5){
  ...
  const increaseValue =()=>{
    if(document.getElementById("inputID2").value >= 5){
                  ...
                  <div className="col-md-8 mx-auto px-4 mt-2">
                    <div className="row">
                      ...
                      <div className ="col-md-6">
                        <ul class="pagination justify-content-end quantity">
                          <li class="page-item">
                            <button class="page-link" onClick={decrease}><i className ="fas fa-minus"></i></button>
                            </li>
                          <li class="page-item">
                            <input disabled type = "text" id = "inputID" value ={update} min="1" max="5" class="page-link inputClass"/>
                            </li>
                          <li class="page-item">
                            <button class="page-link" onClick={increase}><i class="fas fa-plus"></i></button>
                            </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div className ="row">
                      <div className ="col-md-9 items">
                        <p><i className ="fas fa-trash trashClass "> <span className = "fnt"> Remove item </span></i></p>
                        <p><i className =" fas fa-heart heartClass"> <span className ="fnt"> Move to wish list </span></i></p>
                      </div>
                      <div className ="col-md-3 d-flex justify-content-end price">
                        <h5>$<span> {` ${rs === 0 ? ` ${rs}.00  ` : `${rs}  `}`}</span></h5>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="col-md-8 mx-auto px-4 mt-2">
                    <div className="row">
                      ...
                      <div className ="col-md-6">
                        <ul class="pagination justify-content-end quantity">
                          <li class="page-item">
                            <button class="page-link" onClick={decreaseValue}><i className ="fas fa-minus"></i></button>
                            </li>
                          <li class="page-item">
                            <input disabled type = "text"  id="inputID2" value ={update2} min="1" max="5" class="page-link inputClass"/>
                            </li>
                          <li class="page-item">
                            <button class="page-link" onClick={increaseValue}><i class="fas fa-plus"></i></button>
                            </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div className ="row">
                      ...
                      <div className ="col-md-4 d-flex justify-content-end price">
                        <h5>$<span>{` ${rs2 === 0 ? ` ${rs2}.00  ` : `${rs2}  `}`}</span></h5>
                      </div>
                    </div>
                  </div>
                </div>
